    ...
    <footer className="nautide-footer">
      <div className="footer-container">
        <div className="box">
          ...
          <p>
            © 2024 Bakay Diri Store. All Rights Reserved. All content on this
            platform is the property of Bakay Diri-Store.Inc. Duplication and
